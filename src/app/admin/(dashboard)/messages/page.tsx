        ...
        {list.map((message) => (
          <div
            ...
            className={`rounded-2xl border p-5 ${
              message.is_read ? "border-navy/10 bg-white" : "border-gold/40 bg-gold/5"
            }`}
          >
            <div className="flex flex-wrap items-start justify-between gap-3">
              ...
              <div className="flex items-center gap-2">
                ...
                <MessageReadToggle id={message.id} isRead={message.is_read} />
              </div>
            </div>
            <p className="mt-3 text-sm text-navy/80">{message.message}</p>
